...
| Returns        |                                             | pd.DataFrame: The historical data if fetched successfully. str: In the case of certain server responses, such as not being subscribed to historical data for the asset you're trying to fetch None: Otherwise                                                                          | _required_    |
