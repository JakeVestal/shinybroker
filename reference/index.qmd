...
| | |
| --- | --- |
| [fetch_historical_data](fetch_historical_data.qmd#shinybroker.fetch_historical_data) | Creates a temporary IBKR client socket at the specified `host`, `port`, and |
| [fetch_sec_def_opt_params](fetch_sec_def_opt_params.qmd#shinybroker.fetch_sec_def_opt_params) | Creates a temporary IBKR client socket at the specified `host`, `port`, and |
