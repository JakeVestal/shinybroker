...
You can. Go right ahead. However, sometimes it might be handy for you to
NOT have to look up all the `conId`s and instead, just loop through
contract parameters like this:
...
| Type     | Description                                       |
|----------|---------------------------------------------------|
| Contract | A Contract object that can be used in API queries |
